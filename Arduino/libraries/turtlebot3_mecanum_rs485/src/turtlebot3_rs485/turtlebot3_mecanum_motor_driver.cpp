...
#include "../../include/turtlebot3_mecanum_rs485/turtlebot3_mecanum_motor_driver.h"
...
bool Turtlebot3MotorDriver::init(String turtlebot3, int baudrate, char* debug_buf){
  ...
  else dynamixel_limit_max_velocity_ = BURGER_DXL_LIMIT_MAX_VELOCITY;
...
bool Turtlebot3MotorDriver::controlMotor(const float wheel_radius, const float wheel_separation, float* value){
	...
	wheel_velocity_cmd[LEFT_REAR] = lin_x_vel + lin_y_vel - wheel_separation * ang_vel;
	wheel_velocity_cmd[RIGHT_REAR] = lin_x_vel - lin_y_vel + wheel_separation * ang_vel;
	wheel_velocity_cmd[LEFT_FRONT] = lin_x_vel - lin_y_vel - wheel_separation * ang_vel;
	wheel_velocity_cmd[RIGHT_FRONT] = lin_x_vel + lin_y_vel + wheel_separation * ang_vel;
