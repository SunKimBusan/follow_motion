...
#include "../../include/turtlebot3_mecanum_armed/turtlebot3_mecanum_sensor.h"

Turtlebot3Sensor::Turtlebot3Sensor(){}
Turtlebot3Sensor::~Turtlebot3Sensor(){  DEBUG_SERIAL.end();}
bool Turtlebot3Sensor::init(void){
  ...
  if (get_error_code != 0x00)    DEBUG_SERIAL.println("Failed to init Sensor");
  else    DEBUG_SERIAL.println("Success to init Sensor");
  return get_error_code;
}

void Turtlebot3Sensor::initIMU(void){imu_.begin();}
void Turtlebot3Sensor::updateIMU(void){imu_.update();}
