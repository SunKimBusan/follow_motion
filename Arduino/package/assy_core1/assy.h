...
//mecanum
//#define WHEEL_RADIUS                     0.025           // meter
//#define WHEEL_SEPARATION                 0.129           // meter (width : 0.151, length : 0.107)

//Big mecanum
#define WHEEL_RADIUS                     0.050           // meter
#define WHEEL_SEPARATION                 0.2415           // meter (center to wheel width 112.5mm + center to wheel forward length 129mm )
