...
void publishDriveInformation(void)
{
  ...
  // joint states
  // 일단 바퀴만 보낸다. arm 은 나중에 필요하면 보내던지
  // ros topic 받는 부분이 어떻게 처리되어 있는지 확인해봐야 할 듯.
  updateJointStates();
...
void updateJointStates(void)
{
  ...
  static float joint_states_pos[JOINT_NUM] = {0.0,0.0,0.0,0.0};
  static float joint_states_vel[JOINT_NUM] = {0.0,0.0,0.0,0.0};
...
{
  // "wheel1","wheel2","wheel3","wheel4", don't consider arms' states here
  static char *joint_states_name[] = {
    (char*)"wheel1",(char*)"wheel2", (char*)"wheel3",(char*)"wheel4"
  };
