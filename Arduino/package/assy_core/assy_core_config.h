...
#define JOINT_NUM                   4  //4 wheels, don't consider arms' num
...
ros::Subscriber<std_msgs::Int32MultiArray> arm_sub("arm_pos", armCallback);
...
int32_t arm_target_position[8] = {0, 0, 0, 0, 0, 0, 0, 0};
