...
void publishJointStates(){
  ...
  // change direction to webots motor's standard
  motorSetPositionSrv_1.request.value = -l_sho_pitch;
  motorSetPositionSrv_2.request.value = l_sho_roll;
  motorSetPositionSrv_3.request.value = -l_el_pitch;
  motorSetPositionSrv_4.request.value = l_el;

  motorSetPositionSrv_5.request.value = -r_sho_pitch;
  motorSetPositionSrv_6.request.value = -r_sho_roll;
  motorSetPositionSrv_7.request.value = r_el_pitch;
  motorSetPositionSrv_8.request.value = r_el;
...
int main(int argc, char **argv) {
  ...
  motorSetPositionClient_1 = n.serviceClient<webots_ros::set_float>(controllerName + '/' + "LeftShoulder" + "/set_position");
  motorGetTargetPositionClient_1 = n.serviceClient<webots_ros::get_float>(controllerName + '/' + "LeftShoulder" + "/get_target_position");
  ...
  motorSetPositionClient_3 = n.serviceClient<webots_ros::set_float>(controllerName + '/' + "LeftElbow" + "/set_position");
  motorGetTargetPositionClient_3 = n.serviceClient<webots_ros::get_float>(controllerName + '/' + "LeftElbow" + "/get_target_position");
  ...
  motorSetPositionClient_6 = n.serviceClient<webots_ros::set_float>(controllerName + '/' + "RightArm" + "/set_position");
  motorGetTargetPositionClient_6 = n.serviceClient<webots_ros::get_float>(controllerName + '/' + "RightArm" + "/get_target_position");
  ...
  motorSetPositionClient_8 = n.serviceClient<webots_ros::set_float>(controllerName + '/' + "RightForearm" + "/set_position");
  motorGetTargetPositionClient_8 = n.serviceClient<webots_ros::get_float>(controllerName + '/' + "RightForearm" + "/get_target_position");

  set_dxl_position_client = n.serviceClient<dynamixel_workbench_msgs::DynamixelCommand>("/dynamixel_workbench/dynamixel_command");
