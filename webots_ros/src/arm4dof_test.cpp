...
void publishJointStates(){
  ...
  motorSetPositionSrv_4.request.value = l_el-M_PI/2;
...
int main(int argc, char **argv) {
  ...
  motorSetPositionClient_6 = n.serviceClient<webots_ros::set_float>(controllerName + '/' + "Rev1" + "/set_position");
  motorGetTargetPositionClient_6 = n.serviceClient<webots_ros::get_float>(controllerName + '/' + "Rev1" + "/get_target_position");
  motorSetPositionClient_2 = n.serviceClient<webots_ros::set_float>(controllerName + '/' + "Rev2" + "/set_position");
  motorGetTargetPositionClient_2 = n.serviceClient<webots_ros::get_float>(controllerName + '/' + "Rev2" + "/get_target_position");
  motorSetPositionClient_8 = n.serviceClient<webots_ros::set_float>(controllerName + '/' + "Rev3" + "/set_position");
  motorGetTargetPositionClient_8 = n.serviceClient<webots_ros::get_float>(controllerName + '/' + "Rev3" + "/get_target_position");
  motorSetPositionClient_4 = n.serviceClient<webots_ros::set_float>(controllerName + '/' + "Rev4" + "/set_position");
  motorGetTargetPositionClient_4 = n.serviceClient<webots_ros::get_float>(controllerName + '/' + "Rev4" + "/get_target_position");
