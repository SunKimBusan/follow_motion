...
void calcJointStates(const openpose_ros_msgs::OpenPoseHuman3D &person_to_follow){
  ...
  if(body_position_[LShoulder] != Eigen::Vector3d(0.0, 0.0, 0.0) &&
    ...
    joint_angles_["l_sho_pitch"] = joint_filter.setRawSeq1(theta0);
    joint_angles_["l_sho_roll"] = joint_filter.setRawSeq2(theta1);
    joint_angles_["l_el_pitch"] = joint_filter.setRawSeq3(theta2);
    joint_angles_["l_el"] = joint_filter.setRawSeq4(theta3);
  }
  ...
  if(body_position_[RShoulder] != Eigen::Vector3d(0.0, 0.0, 0.0) &&
    ...
    joint_angles_["r_sho_pitch"] = joint_filter.setRawSeq5(theta0);
    joint_angles_["r_sho_roll"] = joint_filter.setRawSeq6(theta1);
    joint_angles_["r_el_pitch"] = joint_filter.setRawSeq7(theta2);
    joint_angles_["r_el"] = joint_filter.setRawSeq8(theta3);
  }
