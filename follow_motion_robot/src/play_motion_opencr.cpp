...
#include <follow_motion_robot/MotionData.h>
#include <Eigen/Dense>
...
void calcJointStates(const follow_motion_robot::MotionData::ConstPtr& msg){
...
void motionCallback(const follow_motion_robot::MotionData::ConstPtr& msg) {
